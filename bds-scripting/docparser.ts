...
import { FileWriter } from '../bdsx/bdsx/writer/filewriter';
...
const targetDir = './bdsx/bdsx/externs';
const OUT_SCRIPTING = path.join(targetDir, 'generated.scripting.d.ts');
const OUT_ADDONS = path.join(targetDir, 'generated.addons.d.ts');
