...
export namespace fsutil {
     ...
     * @returns
     */
    export function replaceExt(filepath:string, extname:string):string {
        const matched = EXT_REGEXP.exec(filepath);
        if (matched == null) return filepath+extname;
    ...
    export async function isModified(from:string, to:string):Promise<boolean> {
