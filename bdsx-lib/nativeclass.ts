...
export class NativeClass extends StructurePointer {
    ...
    static setExtends<T extends NativeClass, THIS extends T>(this:{prototype:THIS}, supercls:NativeClassType<T>):void {
        (this as any).__proto__ = supercls;
        (this as any).prototype._proto__ = supercls.prototype;
    }
