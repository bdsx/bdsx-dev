...
export namespace asm {
    ...
    export class Operation {
        ...
        isRegisterModified(r:Register):boolean {
            ...
            if (this.code.name.split('_', 2)[1] !== 'r') return false;
            if (this.code.name.startsWith('cmp_')) return false;
            if (this.code.name.startsWith('test_')) return false;
            if (this.code.name.startsWith('set')) return false;
            if (this.code.name.startsWith('jmp')) return false;
            return true;
        }
