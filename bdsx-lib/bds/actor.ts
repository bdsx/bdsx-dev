...
export const DimensionId = minecraft.DimensionId;
/** @deprecated import it from bdsx/enums */
export type DimensionId = minecraft.DimensionId;
...
export class Actor extends NativeClass {
    ...
    static fromNewActor(newActor:minecraft.Actor&{[legacyLink]?:Actor}):Actor {
