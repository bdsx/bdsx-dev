...
import { MinecraftPacketIds, ModalFormRequestPacket, NetworkIdentifier, SetTitlePacket } from "../minecraft";
...
class SentForm {
    ...
    constructor(
        public readonly networkIdentifier:NetworkIdentifier|NetworkIdentifierLegacy,
        public readonly resolve: (data:FormResponse<any>)=>void,
        public readonly reject: (err:Error)=>void) {
        this.networkIdentifier = networkIdentifier as any;
...
export class Form<DATA extends FormData> {
    ...
    static sendTo<T extends FormData['type']>(target:NetworkIdentifier|NetworkIdentifierLegacy, data:FormData&{type:T}, opts?:Form.Options):Promise<FormResponse<T>> {
