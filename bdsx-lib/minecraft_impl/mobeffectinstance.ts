...
import { MobEffectInstance } from "../minecraft";
...
declare module "../minecraft" {
    interface MobEffectInstance {
        ...
        constructWith(id: MobEffectIds, duration:int32_t,
            durationEasy:int32_t, durationNormal:int32_t, durationHard:int32_t,
            amplifier:int32_t, ambient:bool_t, showParticles:bool_t, displayAnimation:bool_t):void;
    }
}

MobEffectInstance.define({
    id: uint32_t,
    duration: int32_t,
    durationEasy: int32_t,
    durationNormal: int32_t,
