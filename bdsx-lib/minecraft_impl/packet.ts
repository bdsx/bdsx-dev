...
import { BinaryStream, ExtendedStreamReadResult, MinecraftPacketIds, MinecraftPackets, NetworkIdentifier, Packet, ReadOnlyBinaryStream } from "../minecraft";
...
Packet.prototype.sendTo = function(target:NetworkIdentifier, unknownarg:number=0):void {
    mcglobal.networkHandler.send(target, this, unknownarg);
};
